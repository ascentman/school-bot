...
NAME_TOO_LONG = "❗ Задовге ПІБ. Максимум — 200 символів."
NAME_NEEDS_LETTERS = (
    "❗ Схоже, це не ПІБ. Напишіть прізвище, імʼя та по батькові словами."
)
NAME_POSTPONED = (
    "Гаразд, ПІБ можна вказати згодом командою /name.\n"
    "Поки що записав вас так, як ви підписані в Telegram."
)
ASK_NAME_AGAIN = "Напишіть своє ПІБ одним повідомленням."
NAME_UNCHANGED = "Гаразд, лишив ПІБ без змін. Змінити — команда /name."
CONTACT_NOT_YOURS = (
